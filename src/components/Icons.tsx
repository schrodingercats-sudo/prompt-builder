...
export const FlaskIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} viewBox="0 0 20 20" fill="currentColor">
    <path fillRule="evenodd" d="M7 2a1 1 0 00-1 1v1a1 1 0 001 1h6a1 1 0 001-1V3a1 1 0 00-1-1H7zM5 8a1 1 0 011-1h8a1 1 0 110 2H6a1 1 0 01-1-1zm3 5a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
...
export const WandIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 20 20" fill="currentColor">
      <path d="M10 3.5a1.5 1.5 0 01.956 2.818l-5.32 3.12a1.5 1.5 0 01-1.912-2.586l5.32-3.12A1.5 1.5 0 0110 3.5zM3.5 10a1.5 1.5 0 012.818.956l3.12 5.32a1.5 1.5 0 01-2.586 1.912l-3.12-5.32A1.5 1.5 0 013.5 10zM10 16.5a1.5 1.5 0 01-1.273-2.318l5.32-3.12a1.5 1.5 0 011.912 2.586l-5.32 3.12A1.5 1.5 0 0110 16.5z"/>
    </svg>
);
...
export const GlobeIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2h8a2 2 0 002-2v-1a2 2 0 012-2h1.945M7.705 11a10.007 10.007 0 014.59 0m4.59 0a10.007 10.007 0 014.59 0M12 21a9 9 0 110-18 9 9 0 010 18z"/>
  </svg>
);
...
export const LogoIcon: React.FC<IconProps> = ({ className }) => (
  <img src="https://obliged-red-tnfhnynopx.edgeone.app/boo%20chat.png" alt="Promptimzer Logo" className={className} />
);
